...
export default function ClinicianNotificationsScreen() {
    ...
    const handleNotificationPress = async (notification: Notification) => {
        ...
        if (data?.appointment_id) {
            router.push(`/(clinician)/session/${data.appointment_id}` as any);
        }
    };
                ...
                ListEmptyComponent={
                    <View style={styles.emptyState}>
                        ...
                        <Text style={styles.emptySubtitle}>
                            You'll receive notifications about new bookings, session updates, and patient activity.
                        </Text>
                    </View>
                }
            />
